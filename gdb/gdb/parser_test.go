...
func TestT(t *testing.T)  {
	var a = `=breakpoint-modified,bkpt=[{number="4",type="breakpoint",disp="keep",enabled="y",addr="<MULTIPLE>",times="0",original-location="free"},{number="4.1",enabled="y",addr="0x00007ffff7dd388d",func="free",file="../include/rtld-malloc.h",fullname="/usr/src/debug/glibc-2.28/include/rtld-malloc.h",line="50",thread-groups=["i1"]},{number="4.2",enabled="y",addr="0x00007ffff7dd44bc",func="free",file="../include/rtld-malloc.h",fullname="/usr/src/debug/glibc-2.28/include/rtld-malloc.h",line="50",thread-groups=["i1"]}]`
	checkParseRecord(t, a, `{}`)
}